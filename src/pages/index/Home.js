...
const ITE = () => {
  ...
  return (
    <>
      {/* {
        <ModalInit
          imgLink="https://itetlax.org.mx/assets/img/imgC_A/sesioncg.png"
          url="https://itetlax.org.mx/assets/img/imgC_A/sesioncg.png"
          linkToo=""
        />
      } */}
      {
      ...
      <div className="Home__boxesTriple mt-4">
        ...
        <div>
          ...
          <div className="Home__video-embed ratio ratio-16x9 w-100">
            <iframe
              src="https://www.youtube-nocookie.com/embed/oP9Us3MTaaQ"
              title="Sesión Publica Extraordinaria del CG 30/11/2023"
              allowFullScreen
            ></iframe>
          </div>
          <h5 className="mt-3 text-center">
            Sesión Publica Extraordinaria del CG 30/11/2023{" "}
          </h5>
        </div>
        <div>
