...
import { dataBoletines2017 } from "../../../data/dataBoletines";
import TitlePages from "../../../layout/TitlePages";

const Boletines2017 = () => {
  useEffect(() => {
    document.title = `Boletines 2017`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Comunicación Social" subTitle="Boletines 2017" />

      <MaterialReactTable
        columns={columns}
        data={dataBoletines2017}
