...
import { dataBoletines2016 } from "../../../data/dataBoletines";
import TitlePages from "../../../layout/TitlePages";

const Boletines2016 = () => {
  useEffect(() => {
    document.title = `Boletines 2016`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Comunicación Social" subTitle="Boletines 2016" />

      <MaterialReactTable
        columns={columns}
        data={dataBoletines2016}
