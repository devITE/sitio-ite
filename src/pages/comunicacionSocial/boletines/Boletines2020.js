...
import { dataBoletines2020 } from "../../../data/dataBoletines";
import TitlePages from "../../../layout/TitlePages";

const Boletines2020 = () => {
  useEffect(() => {
    document.title = `Boletines 2020`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Comunicación Social" subTitle="Boletines 2020" />

      <MaterialReactTable table={table} />
    </>
  );
};
export default Boletines2020;
