...
import { dataBoletines2023 } from "../../../data/dataBoletines";
import TitlePages from "../../../layout/TitlePages";

const Boletines2023 = () => {
  useEffect(() => {
    document.title = `Boletines 2023`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Comunicación Social" subTitle="Boletines 2023" />

      <MaterialReactTable table={table} />
    </>
  );
};
export default Boletines2023;
