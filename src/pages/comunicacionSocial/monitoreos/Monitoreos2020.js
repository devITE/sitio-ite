...
import { dataMonitoreos2020 } from "../../../data/dataMonitoreos";
import TitlePages from "../../../layout/TitlePages";

const Monitoreos2020 = () => {
  useEffect(() => {
    document.title = `Monitoreos 2020`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Comunicación Social" subTitle="Monitoreos 2020" />
      <MaterialReactTable
        columns={columns}
        data={dataMonitoreos2020}
