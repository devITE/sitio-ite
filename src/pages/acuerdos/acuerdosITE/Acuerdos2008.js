...
const AcuerdosITE2008 = () => {
  useEffect(() => {
    document.title = `Acuerdos ITE 2008`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Acuerdos ITE" subTitle="Acuerdos ITE 2008" />
      <Expandible />
...
export default AcuerdosITE2008;
