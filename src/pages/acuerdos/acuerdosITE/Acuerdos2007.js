...
const AcuerdosITE2007 = () => {
  useEffect(() => {
    document.title = `Acuerdos ITE 2007`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Acuerdos ITE" subTitle="Acuerdos ITE 2007" />
      <Expandible />
...
export default AcuerdosITE2007;
