...
const AcuerdosITE2017 = () => {
  useEffect(() => {
    document.title = `Acuerdos ITE 2017`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Acuerdos ITE" subTitle="Acuerdos ITE 2017" />
      <Expandible />
...
export default AcuerdosITE2017;
