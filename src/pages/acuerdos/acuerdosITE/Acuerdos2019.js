...
const AcuerdosITE2019 = () => {
  useEffect(() => {
    document.title = `Acuerdos ITE 2019`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Acuerdos ITE" subTitle="Acuerdos ITE 2019" />
      <Expandible />
...
export default AcuerdosITE2019;
