...
const AcuerdosITE2021 = () => {
  useEffect(() => {
    document.title = `Acuerdos ITE 2021`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Acuerdos ITE" subTitle="Acuerdos ITE 2021" />
      <Expandible />
...
export default AcuerdosITE2021;
