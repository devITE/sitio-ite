    ...
    return (
      <div>
        <div className="bottom_title">
          <img
            src={Acuerdos__imgpath(`./h_2021.png`)}
            alt="Acuerdos 2021"
