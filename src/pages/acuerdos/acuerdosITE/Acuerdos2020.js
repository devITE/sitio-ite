...
const AcuerdosITE2020 = () => {
  useEffect(() => {
    document.title = `Acuerdos ITE 2020`;
  }, []);
  ...
  return (
    <>
      <TitlePages title="Acuerdos ITE" subTitle="Acuerdos ITE 2020" />
      <Expandible />
      <MaterialReactTable table={tableAcuerdos} />
    </>
  );
};
export default AcuerdosITE2020;
