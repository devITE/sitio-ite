...
const PrincipiosRectores = () => {
  ...
  return (
    <>
      ...
      <p>
        La Constitución Política del Estado de Tlaxcala en su artículo 95 señala
        que el Instituto Tlaxcalteca de Elecciones, cumplirá sus funciones bajo
        los principios de constitucionalidad, legalidad, imparcialidad,
        objetividad, equidad, certeza, profesionalismo, independencia y máxima
        publicidad.
      </p>
      <p>
        ...
        rectores en el ejercicio de la función electoral, la constitucionalidad,
        legalidad, certeza, autonomía, independencia, imparcialidad, equidad,
        objetividad, profesionalismo y máxima publicidad
      </p>
      ...
      <div className="PrincipiosRectores">
        ...
        <div>
          ...
          Referido al apego escrupuloso que mantiene el Instituto en el mandato
          constitucional para el ejercicio de sus atribuciones y el desempeño de
      ...
      <div className="PrincipiosRectores mt-3">
        ...
        <div>
          <h4>Legalidad</h4>
          El Instituto Tlaxcalteca de Elecciones debe observar escrupulosamente
          el mandato constitucional en el ejercicio de las atribuciones y el
          desempeño de las funciones que tiene encomendadas, así como las
      ...
      <div className="PrincipiosRectores mt-3">
        ...
        <div>
          ...
          Institución para que sus procesos de deliberación y toma de decisiones
          se den con absoluta libertad y respondan única y exclusivamente al
          imperio de la ley.Es la garantía que disponen las autoridades que
      ...
      <div className="PrincipiosRectores mt-3">
        ...
        <div>
          ...
          Elecciones debe reconocer y velar permanentemente por el interés de la
          sociedad y por los valores fundamentales de la democracia, supeditando
          a éstos, de manera irrestricta, cualquier interés personal o
      ...
      <div className="PrincipiosRectores mt-3">
        ...
        <div>
          ...
          parciales o unilaterales, máxime si éstas pueden alterar la expresión
          o consecuencia del quehacer del Instituto.
        </div>
      </div>
      <div className="PrincipiosRectores mt-3">
        <div className="bg-ite"> </div>
        <div>
          ...
          Se establece como una condición que mantiene el Instituto Tlaxcalteca
          de elecciones en el desarrollo de sus actividades en base a la
          eficacia, aplicación, seriedad, honradez y pericia.
        </div>
      </div>
      <div className="PrincipiosRectores mt-3">
        <div className="bg-ite"> </div>
        <div>
          ...
          Todos los actos y la información en poder del Instituto Tlaxcalteca de
          Elecciones son públicos y sólo por excepción se podrán reservar en los
          casos expresamente previstos por las leyes y justificados bajo
      ...
      <div className="PrincipiosRectores mt-3">
        ...
        <div>
          <h4>Paridad</h4>
          La paridad es un principio constitucional que tiene como finalidad la
          igualdad sustantiva entre los sexos, que adopta nuestro país como
