    ...
    <>
      ...
      <ol>
        ...
        <li>
          ...
          bien para regular temas de interés social, pertenecer a una asociación
          civil, solo en el caso de participar por el principio de
          representación proporcional, descargar la solicitud de inscripción,
          una identificación oficial, un comprobante de domicilio y presentarlos
          ante el Congreso del Estado o en la Dirección del Organización
          Electoral, Capacitación y Educación Cívica del ITE.
        </li>
        <li>
          Realizar la exposición de la iniciativa ante las y los integrantes del
          jurado calificador.
        </li>
        <li>
          De resultar seleccionada o seleccionado, participar en la capacitación
          que imparte la Comisión Organizadora.
        </li>
