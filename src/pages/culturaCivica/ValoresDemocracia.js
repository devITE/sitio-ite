...
export const ValoresDemocracia = () => {
  ...
  return (
    <>
      ...
      <ol>
        <li>
          Oficio de la institución educativa dirigido a la Presidencia del ITE.
        </li>
        <li>
          El ITE atenderá la solicitud a través de la Dirección del Organización
          Electoral, Capacitación y Educación Cívica quién designará al personal
          encargado como enlace para el calendarizar el desarrollo de la
          actividad.
        </li>
        <li>
        ...
        <li>
          ...
          educativo por ser un agente difusor de los “Valores de la Democracia”.
        </li>
      </ol>
