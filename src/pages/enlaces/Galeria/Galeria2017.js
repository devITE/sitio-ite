...
export const Galeria2017 = () => {
  useEffect(() => {
    document.title = `Galeria 2017`;
  }, []);
  return (
    <>
      <NavbarEnlaces title="Galería Fotográfica 2017" />
      <Accordion idAccordion="galeria2017">
        {dataGaleria2017.map((infoAccordion) => (
          <AccordionItem
