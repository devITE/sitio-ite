...
import { dataArt672020 } from "../../../data/dataTransparenciaArt67";

const Art672020 = () => {
  useEffect(() => {
    document.title = `Artículo 67 2020`;
  }, []);
  ...
  return (
    <>
      <TitlePages
        title="Transparencia"
        subTitle="Artículo 67. (2020) Obligaciones Específicas"
      />
      <MaterialReactTable
        columns={columns}
        data={dataArt672020}
